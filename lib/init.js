...
module.exports = (appId) => {
  ...
  if (fs.existsSync(cliFile)) {
    ...
    try {
      ...
      const {appId, cliVersion} = cliInfos;
      console.log(
  ...
  tryGenerateFile(bundlePackageFile, () => genBundlePackage(appId));
...
${workingDir}/
  ...
  |       ├── config.js           // is xcraft-core-etc config file
  |       ├── entities            // put here your entity services
  |       ├── ${appId}.js         // xcraft service file descriptor
