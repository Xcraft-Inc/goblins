...
goblins craft service guest-manager
mkdir lib/goblin-cheese
goblins select goblin-cheese
goblins craft service cheese-provider
...
`
  ...
  .command(
    'craft <type> <name>',
    `craft initial files based on type
